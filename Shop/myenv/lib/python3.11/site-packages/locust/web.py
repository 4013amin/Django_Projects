...
class WebUI:
    ...
    """Arguments used to render menu_detail.html for the web UI. Must be used with custom templates
    extending menu_detail.html."""
    ...
    def __init__(
        ...
        def index() -> str | Response:
            ...
            return render_template("menu_detail.html", template_args=self.template_args)
